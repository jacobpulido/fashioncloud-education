...
let EntregasService = (() => {
    ...
    var EntregasService = class {
        ...
        async findPendientes(institucionId) {
        ...
        async enviar(actividadId, alumnoId, institucionId) {
        ...
        async evaluar(id, decision, puntaje, comentario, docenteId) {
